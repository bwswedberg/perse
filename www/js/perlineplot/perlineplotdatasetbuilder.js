...
define([
    ...
    perlineplot.PerLinePlotDataSetBuilder = function () {
    ...
    perlineplot.PerLinePlotDataSetBuilder.prototype.setMetadata = function (mData) {
        this.metadata = mData;
        return this;
    };

    perlineplot.PerLinePlotDataSetBuilder.prototype.setCalendarName = function (calendarName) {
        this.calendarName = calendarName;
        return this;
    };

    perlineplot.PerLinePlotDataSetBuilder.prototype.setCycleName = function (cycleName) {
        this.cycleName = cycleName;
        return this;
    };

    perlineplot.PerLinePlotDataSetBuilder.prototype.setData = function (data) {
    ...
    perlineplot.PerLinePlotDataSetBuilder.prototype.createMonthOfYearData = function () {
        var cal = $.calendars.instance(this.calendarName),
            newData = [],
    ...
    perlineplot.PerLinePlotDataSetBuilder.prototype.extentsShouldBeWithinJulianRangeTest = function (data) {
    ...
    perlineplot.PerLinePlotDataSetBuilder.prototype.createDayOfWeekData = function () {
        var cal = $.calendars.instance(this.calendarName),
            extent = this.getJulianDateExtent(),
    ...
    perlineplot.PerLinePlotDataSetBuilder.prototype.createDayOfMonthData = function () {
        var cal = $.calendars.instance(this.calendarName),
            newData = [],
            extent = this.getJulianDateExtent(),
    ...
    perlineplot.PerLinePlotDataSetBuilder.prototype.createWeekOfYearData = function () {
        var cal = $.calendars.instance(this.calendarName),
            newData = [],
            extent = this.getJulianDateExtent(),
    ...
    perlineplot.PerLinePlotDataSetBuilder.prototype.createDayOfYearData = function () {
        var cal = $.calendars.instance(this.calendarName),
            newData = [],
    ...
    perlineplot.PerLinePlotDataSetBuilder.prototype.getJulianDateExtent = function () {
        var m = this.metadata.temporal;
        return {min: m.beginJulianDate, max: m.endJulianDate};
    };

    perlineplot.PerLinePlotDataSetBuilder.prototype.getJulianDateExtent_dep = function () {
    ...
    perlineplot.PerLinePlotDataSetBuilder.prototype.build = function () {
        var newData;
